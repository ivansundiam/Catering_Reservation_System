<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @else
                        <x-nav-link href="{{ route('admin.reservations') }}" :active="request()->routeIs(['admin.reservations', 'admin.reservation.show'])">
                            {{ __('Reservations') }}
                        </x-nav-link>
                        ...
                        <x-nav-link href="{{ route('users.archive') }}" :active="request()->routeIs('users.archive')">
                            {{ __('Archive') }}
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="{{ route('admin.reservations') }}" :active="request()->routeIs(['admin.reservations', 'admin.reservation.show'])">
                {{ __('Reservations') }}
