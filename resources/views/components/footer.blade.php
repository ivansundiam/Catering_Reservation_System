    ...
    <div class="container grid w-full md:grid-cols-3 gap-y-5 gap-x-9">
        <div>
            ...
            <div class="mt-8">
                ...
                <div class="flex mt-2">
                    <a href="" class="mr-3 bg-yellow-800 rounded-full hover:scale-105">
        ...
        <div>
            ...
            <dd class="text-gray-400 ">
                <dl class="flex items-center mt-3 leading-5 ">
                    <span class="mr-2">
                    ...
                    Address: Unit 107 Westria Residences 77 West ave. Quezon City, Philippines
                </dl>
                <dl class="flex items-center mt-3 leading-5 ">
                    <span class="mr-2">
                    ...
                    Office: (+632) 8371-1098 ; (+632) 8372-9755
                </dl>
                <dl class="flex items-center mt-3 ">
                    <span class="mr-2">
