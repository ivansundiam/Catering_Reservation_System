    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="p-10 overflow-hidden bg-white shadow-xl dark:bg-gray-800 sm:rounded-lg">
                <p class="mb-5 text-xl">Reservations</p>
                ...
                <div class="relative overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 rtl:text-right">
                        ...
                        <tbody>
                                ...
                                <tr class="bg-white border-b">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex justify-evenly">
                                            <a href="{{ route('reservation.show', $res->id) }}" class="size-8 !p-0 btn-info">
                                            ...
                                            <a href="{{ route('reservation.show', $res->id) }}" class="size-8 !p-0 btn-danger">
                            ...
                            @empty
                            <tr class="bg-white border-b">
                                <td colspan="6" class="text-xl text-center py-2 text-gray-400">No reservations</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
