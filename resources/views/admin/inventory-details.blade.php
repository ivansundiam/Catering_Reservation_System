<x-admin-layout> 
    <x-slot name="title">
        {{ __('Item Details | ' . config('app.name')) }}
    </x-slot>

    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="p-4 overflow-hidden bg-white shadow-xl md:p-10 dark:bg-gray-800 sm:rounded-lg">
                <p class="text-xl ">Item details</p>

                <x-section-border />

                <a href="{{ route('inventory.index') }}" class="absolute p-3 transition duration-150 ease-in rounded-full hover:bg-gray-100 active:bg-gray-200">
                ...
                <div class="pt-10 mx-auto lg:pt-0 lg:w-3/4">
                    @livewire('inventory.details', ['item' => $item])
                </div>
