<x-app-layout>
    <div class="relative selection:bg-primary selection:text-white h-[420px] lg:h-[620px]" >
        <img src="{{ asset('assets/images/hero-bg.jpg') }}" loading="lazy" fetchPriority="high" class="z-0 w-full bg-cover absolute h-[420px] lg:h-[620px]" alt="Hero image">
        ...
        >
            ...
            >
                <a href="{{ route('reservation.create') }}"  class="duration-300 ease-in-out transform bg-gray-400 rounded-lg shadow-lg hover:shadow-xl hover:scale-110">
                    <img src="{{ asset('assets/images/service1.png') }}" class="package-service" loading="lazy" fetchPriority="high" alt="service 1">
                ...
                <a href="{{ route('reservation.create') }}" class="duration-300 ease-in-out transform bg-gray-400 rounded-lg shadow-lg hover:shadow-xl hover:scale-110">
                    <img src="{{ asset('assets/images/service2.png') }}" class="package-service" loading="lazy" fetchPriority="high" alt="service 2">
                    <h4 class="heading-text !text-2xl text-white mt-3 text-center">package 2</h4>
                    <p class="mb-5 text-center text-white">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Veritatis dignissimos, ea consequatur molestiae officia eligendi?</p>
                </a>
                <a href="{{ route('reservation.create') }}" class="duration-300 ease-in-out transform bg-gray-400 rounded-lg shadow-lg hover:shadow-xl hover:scale-110">
                    <img src="{{ asset('assets/images/service3.png') }}" class="package-service" loading="lazy" fetchPriority="high" alt="service 3">
    ...
    <section class="bg-white selection:bg-primary selection:text-white" id="about"
        ...
        <div class="container flex flex-col py-16 md:flex-row">
            <div class="relative w-full md:w-1/2 ">
                ...
                >
                    <img src="{{ asset('assets/images/about-img1.jpg') }}" class="absolute top-0 object-cover left-[calc(50%-200px)] lg:left-[calc(50%-264px)] w-80 h-40 md:size-64 lg:size-96" loading="lazy" fetchPriority="high" alt="about 1">
                    <img src="{{ asset('assets/images/about-img2.jpg') }}" class="absolute object-cover w-44 h-24 border-4 border-white top-12 left-[calc(50%)] md:w-32 md:h-44 lg:w-48 lg:h-64 md:left-36 md:top-16 lg:left-[calc(50%+12px)] lg:top-28" loading="lazy" fetchPriority="high" alt="about 2">
                </div>
            </div>
            ...
            <div class="grid grid-cols-3 gap-1 mt-10 md:gap-5">
                <div x-show="isOnGallery"
                    ...
                    <button type="button" class="relative inline-block overflow-hidden size-full min-h-28 md:min-h-64">
                        <img src="{{ asset('assets/images/facility1.jpg') }}" class="gallery-img" loading="lazy" fetchPriority="high" alt="facility 1">
                    </button>
                </div>
                <div x-show="isOnGallery"
                    ...
                    <button type="button" class="relative inline-block overflow-hidden size-full min-h-64">
                        <img src="{{ asset('assets/images/facility2.jpg') }}" class="gallery-img" loading="lazy" fetchPriority="high" alt="facility 2">
                    </button>
                </div>
                <div x-show="isOnGallery"
                    ...
                    x-transition:leave-end="opacity-0 translate-y-12">
                    <button type="button" class="relative inline-block overflow-hidden size-full min-h-64">
                        <img src="{{ asset('assets/images/facility3.jpg') }}" class="gallery-img" loading="lazy" fetchPriority="high" alt="facility 3">
                    </button>
                </div>
                <div x-show="isOnGallery"
