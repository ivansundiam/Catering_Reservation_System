            ...
            <div class="p-5 overflow-hidden bg-white shadow-xl md:p-10 dark:bg-gray-800 sm:rounded-lg">
                ...
                <form action="{{ route('reservation.store') }}" 
                    ...
                    <div x-show="step == 1">
                        ...
                        <div class="grid w-full grid-cols-1 mx-auto md:grid-cols-2 gap-x-16">
                            ...
                            <div class="mt-5">
                                ...
                                <select x-model="theme" name="theme" class="w-full input-field" id="theme">
                            ...
                            <div class="mt-5">
                                ...
                                <select x-model="occasion" name="occasion" class="w-full input-field" id="occasion">
                        ...
                        <div class="flex w-full mt-8 justify-center md:justify-end">
                    ...
                    <div x-show="step == 2">
                        ...
                        <div class="grid w-full grid-cols-1 mx-auto md:grid-cols-2 gap-x-16">
                            <div class="mt-5">
                                ...
                                <select x-model="package" name="package" class="w-full input-field" id="package">
                    ...
                    <div x-show="step == 3">
                        ...
                        <ul class="m-0 lg:mx-10 font-noticia text-base">
                            <li>
                        ...
                        <ul class="m-0 lg:mx-10 font-noticia text-base">
                            ...
                            <li>
                                <p>Time: <span x-text="selectedTime"></span></p>
                            </li>
                        </ul>

                        <x-form-divider value="Package Details" />

                        <ul class="m-0 lg:mx-10 font-noticia text-base grid grid-cols-2">
                            <div>
                                <li>
                                    <p>Package: <span x-text="package"></span></p>
                                </li>
                                <li>
                                    <p>Meat: <span x-text=""></span></p>
                                </li>
                                <li>
                                    <p>Dessert: <span x-text=""></span></p>
                                </li>
                                <li>
                                    <p>Appetizer: <span x-text=""></span></p>
                                </li>
                            </div>
                            <div>
                                <li>
                                    <p>Dishes: <span x-text=""></span></p>
                                </li>
                                <li>
                                    <p>Side dish: <span x-text=""></span></p>
                                </li>
                                <li>
                                    <p>Beverages: <span x-text=""></span></p>
                                </li>
                            </div>
                        </ul>
                        ...
                        <div class="px-10 flex w-full justify-end font-noticia">
                            <p>Total Cost:</p>
                        </div>
