                    ...
                    @forelse ($reservations as $reservation)
                        ...
                        <a href="{{ route('reservation.show', $reservation->id) }}"
                            ...
                            @if ($reservation->has_notice)
                                <div
                                    class="absolute px-3 py-0 text-lg font-extrabold text-white bg-red-500 rounded-full top-[-10px] right-3">
                                    !</div>
                            @endif

                            <div
                                class="bg-white w-[75%] border-r border-gray-200 flex flex-col justify-between rounded-l-lg">
